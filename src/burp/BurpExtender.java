         ...
         if (menus != null && menus.size() > 0) {
             for (int i = 0; i < menus.size(); i++) {
                 ...
                 if (menu.getType() == BurpMenuType.NUMBER_0) {
                     ...
                     List<Component> subjmenus = createMenuItems(submenus, traffic);
                     ...
                     menuItem.setAction(new VenariMenuAction(menu, _restClient, logging, _api, sessionID, traffic));
                     ret.add(menuItem);
                 }
             }
         }
     ...
     public List<Component> provideMenuItems(ContextMenuEvent event)
     {
         ...
         try {
             ...
             if (token != null && !token.isEmpty()) {
                 ...
                 menuList = createMenuItems(menus, event.selectedRequestResponses());
             }
         } catch (Exception ex) {
